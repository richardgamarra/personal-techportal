...
const SECTION_META = {
  ...
  Enterprise: {
    icon: Server,
    description:
      "Enterprise support, Windows administration, troubleshooting, and operational content.",
    label: "Enterprise",
  },
  AI: {
    icon: Cpu,
          ...
          <div className={`grid gap-6 border-b px-6 py-6 md:grid-cols-[1.2fr_0.8fr] md:px-8 ${borderClass}`}>
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-4">
                <div className="rounded-[20px] bg-white/10 p-5 text-white">
                  <div className="text-4xl font-bold">
                    {groupedSections.find((g) => g.section === "Resources")?.items.length || 0}
                  </div>
                ...
                <div className="rounded-[20px] bg-white/10 p-5 text-white">
                  <div className="text-4xl font-bold">
                    {groupedSections.find((g) => g.section === "Learning & Certifications")?.items
                      .length || 0}
                  </div>
                ...
                <div className="rounded-[20px] bg-white/10 p-5 text-white">
                  <div className="text-4xl font-bold">
                    {groupedSections.find((g) => g.section === "Enterprise")?.items.length || 0}
                  </div>
                ...
                <div className="rounded-[20px] bg-white/10 p-5 text-white">
                  <div className="text-4xl font-bold">
                    {groupedSections.find((g) => g.section === "Projects")?.items.length || 0}
                  </div>
            ...
            <div className={`${innerCardClass} p-8`}>
              ...
              <div className={`mt-8 space-y-5 text-base leading-9 ${softTextClass}`}>
                ...
                <p>
                  I wanted one professional space where I could connect that experience with what I
                  am learning now in automation, AI tools, and modern platforms.
                </p>
              </div>
